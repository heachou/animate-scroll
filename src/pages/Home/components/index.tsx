...
const BackgroundAnimation = memo(function ({ children,iconAnimationEnd, setIconAnimationEnd }: { children: ReactNode,iconAnimationEnd:boolean,setIconAnimationEnd:Function }) {
  ...
  return (
    <div className={`backgroundAnimation pcAnimation`}
      style={{
